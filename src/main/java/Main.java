...
public class Main extends JFrame {
    ...
    public void execute() {
        ...
        order.setExpectedDeliveryDate(java.sql.Date.valueOf(LocalDate.now().plusDays(3)));//ExpectedDeliveryDate
        ...
        order.setLastEditedWhen(new Timestamp(new Date().getTime()));//LastEditedWhen
