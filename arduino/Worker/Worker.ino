...
void loop()
{
  ...
  if(switchState == 0 && showRobotState.IsSwitchToAutomaticPressed() ){
              jsonrobot.emitRobotState("STATE", "AUTOMATIC", "Switch button was pressed");
      switchState++;
      AUTOMATIC = true;
    }
    if(switchState > 0 && showRobotState.IsSwitchToAutomaticPressed() ){
              jsonrobot.emitRobotState("STATE", "MANUAL", "Switch button was pressed");
      switchState = 0;
      MANUAL = true;
    }
